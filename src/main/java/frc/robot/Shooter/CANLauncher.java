...
public class CANLauncher extends SubsystemBase {
  ...
  public CANLauncher() {
    ...
    m_feedWheel.configure(m_feedWheelConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters);
    m_launchWheel.configure(m_launchWheelConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters);
  }
